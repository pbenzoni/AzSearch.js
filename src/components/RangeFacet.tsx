...
class RangeFacet extends React.PureComponent<PropsType, State> {
    ...
    render() {
        ...
        let onLowerChange = (e) => {
            let lower = Date.parse(e.target.value + " GMT-0400"); // adding timezones to deal with auto offsetting
            let upper = Date.parse(upperValue + " GMT-0400");
        ...
        let onUpperChange = (e) => {
            let upper = Date.parse(e.target.value  + " GMT-0400");
            let lower = Date.parse(lowerValue  + " GMT-0400");
